OBJECTS = main.o pw_api.o gamehook_rc.o common.o d3d.o game_config.o avl.o pw_item_desc.o
...
build/gamehook.dll: $(OBJECTS:%.o=build/%.o) build/libgamehook.dll
	gcc $(CFLAGS) -o $@ -shared -fPIC $(filter %.o,$^) -Wl,--subsystem,windows -Wl,-Bstatic -lgdi32 -ld3d9 -Wl,-Bdynamic build/libgamehook.dll -static-libgcc
